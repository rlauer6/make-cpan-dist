...
This utility should normally be called witht the `--buildspec` option
...
options.  This is probably the preferred way of using this
...
by the `bash` script (`make-cpan-dist`) or you can provide them.
